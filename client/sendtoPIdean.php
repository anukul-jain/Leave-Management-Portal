...
if(isset($user))
	...
	if($flag==0){
		echo 'ManPower has been Requested';
		$sql4="UPDATE projects SET STATUS = 'Granted' where id='".$id."'";
		$conn->query($sql4);
		$sql2 = "INSERT INTO deanviewprojects(PI,Dept,Totalbudgetleft,Description,ManPowerType,ManPmonths,Pname,STATUS) VALUES('".$row3['PI']."','".$row3['Dept']."','".$row3['Totalbudgetleft']."','".$row3['Description']."','".$type."','".$month."','".$row3['ProjectName']."','Requested' )";
		$conn->query($sql2);
	}
	else{

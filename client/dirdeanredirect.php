...
if(isset($user))
	...
	$leavereason = $_POST['leavereason3'];
	$id =$_GET['id'];
	$empid =$_GET['empid'];
	//$dept = $_POST['dept'];
	$sql4 = "UPDATE dirview_leaves SET Status = 'Requested' WHERE id = '".$id."'";
	$conn->query($sql4);
	$sql6 = "UPDATE dirview_leaves SET Remarks = '".$leavereason."' WHERE id = '".$id."'";
	$conn->query($sql6);

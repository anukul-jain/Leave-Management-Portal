						...
						if($row["UserName"] == $user)
							{
								if($leavetype === "Sick Leave")
								{
									...
									else
									{
										$empname = $row["EmpName"];
										$to = $row["EmpEmail"];
										$sql2 = "INSERT INTO emp_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks) VALUES('".$empname."','".$leavetype."','".$row["SickLeave"]."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."' )";
											if (mysqli_query($conn, $sql2))
											{
								...
								if($leavetype === "Earn Leave")
								{
									...
									{
									header('location:PIrequest_leave.php?err='.urlencode("You cannot ask for earn leaves more than that of your account !"));
									}
								}
								if($leavetype === "Casual Leave")
								{
									...
									{
									header('location:PIrequest_leave.php?err='.urlencode("You cannot ask for casual leaves more than that of your account !"));
									}
								}
							}
						}
...
$pdf_content='
								...
								if($row["UserName"] == $user)
									{
										if($leavetype === "Sick Leave")
										{
											if(($leavedays <= $row["SickLeave"]) || $leavedays < 0)
												...
												$to = $row["EmpEmail"];
												$ret=1;
												$sql2 = "INSERT INTO emp_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks,Retro) VALUES('".$empname."','".$leavetype."','".$leavedays."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."','".$ret."' )";
													if (mysqli_query($conn, $sql2))
													{
													$msg = "The Leave Request generated by you is as follows : \nEmployee Name : ".$empname."\nLeave Days Requested : ".$leavedays."\nType of leave : ".$leavetype."\nStarting Date of Leave : ".$leavedate."\n\n\nThank You,\nwebadmin,Leave Management System.";
											...
											{$ret=1;
												$empname = $row["EmpName"];
												$to = $row["EmpEmail"];
												$sql2 = "INSERT INTO emp_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks,Retro) VALUES('".$empname."','".$leavetype."','".$row["SickLeave"]."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."','".$ret."' )";
													if (mysqli_query($conn, $sql2))
													{
													$msg = "The Leave Request generated by you is as follows : \nEmployee Name : ".$empname."\nLeave Days Requested : ".$row["SickLeave"]."\nType of leave : ".$leavetype."\nStarting Date of Leave : ".$leavedate."\n\n\nThank You,\nwebadmin,Leave Management System.";
		...
		$pdf_content='
			...
			{
			header('location:PIrequest_leave.php?err='.urlencode('Pl. Enter some details !'));
			}
	}
	else
	{

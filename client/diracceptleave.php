...
if(isset($_SESSION['user']))
	{
	$sql = "SELECT id,EmpName,LeaveType,RequestDate,Status,LeaveDays,StartDate,EndDate FROM dirview_leaves WHERE id='".$id."'";

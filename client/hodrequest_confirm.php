						...
						if($row["UserName"] == $user)
							{
								if($leavetype === "Sick Leave")
								{
									...
									//header('location:hodrequest_leave.php?err='.urlencode("You cannot ask for sick leaves more than that of your account !"));
									}
								}
								if($leavetype === "Earn Leave")
								{
									...
									{
									header('location:hodrequest_leave.php?err='.urlencode("You cannot ask for earn leaves more than that of your account !"));
									}
								}
								if($leavetype === "Casual Leave")
								{
									...
									{
									header('location:hodrequest_leave.php?err='.urlencode("You cannot ask for casual leaves more than that of your account !"));
									}
								}
							}
						}
...
$pdf_content='
			...
			$reportPDF = createPDF($pdf_content, $name);
				/*}
					...
					{
					header('location:hodrequest_leave.php?err='.urlencode('Start Date is invalid !'));
					}*/
			}
		
		else
			{
			header('location:hodrequest_leave.php?err='.urlencode('Pl. Enter some details !'));
			}
	}
	else
	{

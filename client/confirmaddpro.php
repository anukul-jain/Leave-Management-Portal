...
if(isset($_SESSION['user']))
	{
		...
		$updateResult=$companydb->phase_b_collection->updateOne(array("user"=>$_SESSION['user']),array('$push' => array("pubname" => $pubname)));
		...
		if($companydb->phase_b_collection->count(array("user"=>$_SESSION['user']))==0){
			$updateResult=$companydb->phase_b_collection->insertOne(array("user"=>$_SESSION['user']),array('$push' => array("pubname" => $pubname)));
			$updateResult=$companydb->phase_b_collection->updateOne(array("user"=>$_SESSION['user']),array('$push' => array("pubname" => $pubname)));

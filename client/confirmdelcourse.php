...
if(isset($_SESSION['user']))
	{
		...
		$code=$cursor['ccode'][$index];
		$cname=$cursor['cname'][$index];
		$companydb->phase_b_collection->updateOne(array("user" => $_SESSION['user']),array( '$pull' =>array("ccode" => $code )));
		$companydb->phase_b_collection->updateOne(array("user" => $_SESSION['user']),array( '$pull' =>array("cname" => $cname )));

						...
						if($row["UserName"] == $user)
							{
								if($leavetype === "Sick Leave")
								{
									if(($leavedays <= $row["SickLeave"]) || $leavedays < 0)
										...
										if(strtotime($leavedate) < time()){
											...
											$sql2 = "INSERT INTO dirview_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks,Retro) VALUES('".$empname."','".$leavetype."','".$leavedays."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."','".$retro."')";}
											else{
												$sql2 = "INSERT INTO dirview_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks) VALUES('".$empname."','".$leavetype."','".$leavedays."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."')";}
									//	$sql2 = "INSERT INTO dirview_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks) VALUES('".$empname."','".$leavetype."','".$leavedays."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."')";
											...
											$status = true;
												if($status == true)
													echo "Request Has Been Sucessfully Submitted.<br/><br/>";
											}
											else
											{
									...
									else
									{
										...
										if(strtotime($leavedate) < time()){
											...
											$sql2 = "INSERT INTO dirview_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks,Retro) VALUES('".$empname."','".$leavetype."','".$row["SickLeave"]."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."','".$retro."')";}
											else{
												$sql2 = "INSERT INTO dirview_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks) VALUES('".$empname."','".$leavetype."','".$row["SickLeave"]."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."')";}
										//$sql2 = "INSERT INTO dirview_leaves(EmpName,LeaveType,LeaveDays,StartDate,EndDate,Dept,Remarks) VALUES('".$empname."','".$leavetype."','".$row["SickLeave"]."','".$leavedate."','".$end."','".$row['Dept']."','".$leavereason."' )";
											if (mysqli_query($conn, $sql2))
											{
											$msg = "The Leave Request generated by you is as follows : \nEmployee Name : ".$empname."\nLeave Days Requested : ".$row["SickLeave"]."\nType of leave : ".$leavetype."\nStarting Date of Leave : ".$leavedate."\n\n\nThank You,\nwebadmin,Leave Management System.";
											
											$status = true;
												if($status == true)
													echo "Since the leaves requested were more than available, therefore all the remaining leaves will be deducted if approved.</br>Request Has Been Sucessfully Submitted.<br/>";
											}
											else
											{
											echo "Error: " . $sql . "<br>" . mysqli_error($conn);
											}
									//header('location:deanrequest_leave.php?err='.urlencode("You cannot ask for sick leaves more than that of your account !"));
									}
								}
								if($leavetype === "Earn Leave")
								{
									...
									{
									header('location:deanrequest_leave.php?err='.urlencode("You cannot ask for earn leaves more than that of your account !"));
									}
								}
								if($leavetype === "Casual Leave")
								{
									...
									{
									header('location:deanrequest_leave.php?err='.urlencode("You cannot ask for casual leaves more than that of your account !"));
									}
								}
							}
						}
...
$pdf_content='
			...
			$reportPDF = createPDF($pdf_content, $name);
				...
				/*else
					{
					header('location:deanrequest_leave.php?err='.urlencode('Start Date is invalid !'));
					}*/
			}
		
		else
			{
			header('location:deanrequest_leave.php?err='.urlencode('Pl. Enter some details !'));
			}
	}
	else
	{

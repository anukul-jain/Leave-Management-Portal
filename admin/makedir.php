...
if(isset($_SESSION['adminuser']))
	{
		...
		$sql3="SELECT Dept from director ";
		$result2 = $conn->query($sql3);
		if($result2->num_rows > 0){
			$sql4= "DELETE FROM director ";
			$conn->query($sql4);
		}
		
		$sql2 = "INSERT INTO director (id, username, password , Dept, SetSickLeave, SetCasualLeave, SetEarnLeave) VALUES "."('".$id."','".$uname."','".$pass."','".$dept."','".$sl."','".$cl."','".$el."')";
		$conn->query($sql2);
